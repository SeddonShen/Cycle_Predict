...
parser.add_argument('--corpusFile', default='data/cycle.csv')
...
parser.add_argument('--sequence_length', default=2, type=int) # sequence的长度，默认是用前五天的数据来预测下一天的收盘价
...
parser.add_argument('--save_file', default='model/cycle.pth') # 模型保存位置
